import {
  img_retatrutide, img_cjc1295, img_bpc157, img_tb500,
  img_wolverine, img_ipamorelin, img_ghkcu, img_motsc,
  img_bac, img_kit,
} from './images';

export const PRODUCTS = [
  {
    id: 1, name: 'Retatrutide', cat: 'GLP / Metabolic', badge: 'NEW', img: img_retatrutide,
    variants: [{ l: '10mg', p: 89 }, { l: '20mg', p: 159 }],
  ...
  },
  {
    ...
    variants: [{ l: 'BPC-157 10mg + TB-500 10mg', p: 99 }],
  ...
  },
  {
    ...
    variants: [{ l: '10mg', p: 48 }],
    desc: 'Selective GH secretagogue peptide. Lyophilised, high purity. COA available.',
  },
  {
    id: 7, name: 'GHK-Cu', cat: 'Repair & Recovery', badge: null, img: img_ghkcu,
    variants: [{ l: '50mg', p: 65 }, { l: '100mg', p: 110 }],
  ...
  },
  {
    ...
    variants: [{ l: '10mg', p: 72 }],
    desc: 'Mitochondria-derived peptide. Emerging research compound. Third-party tested. COA available.',
  },
  {
    id: 9, name: 'BAC Water', cat: 'Ancillaries', badge: null, img: img_bac,
    variants: [{ l: '3ml', p: 8 }, { l: '10ml', p: 14 }],
  ...
  },
  {
    ...
    variants: [{ l: 'Kit', p: 24 }],
    desc: '5x insulin needles, 1x 3ml syringe with needle, 10x alcohol wipes, 3x BAC Water 3ml. Everything needed for reconstitution.',
    isAncillary: true,
  },
];
